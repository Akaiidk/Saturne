// Création du projet de la planète Saturne : demi anneau de Saturne arrière, couleur unie
...
int main()
{
    ...
    string nomFichierImage = chemin + "\\Saturne4.bmp";
    ...
    for (int i = 0; i <= x; ++i)
    {
        for (int j = 0; j <= y; ++j)
        {
            ...
            if (estDansDemiAnneauElliptiqueArriere(j, i, yCentreSaturne, xCentreSaturne, GrandRayonInt, PetitRayonInt, GrandRayonExt, PetitRayonExt))
            {

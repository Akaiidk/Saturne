// Création du projet de la planète Saturne : anneau de Saturne, couleur unie
...
int main()
{
    ...
    string nomFichierImage = chemin + "\\Saturne3.bmp";
    ...
    for (int i = 0; i <= x; ++i)
    {
        for (int j = 0; j <= y; ++j)
        {
            ...
            if (estDansAnneauElliptique(j, i, yCentreSaturne, xCentreSaturne, GrandRayonInt, PetitRayonInt, GrandRayonExt, PetitRayonExt))
            {

...
* **Étape 2** : Mise en place des premiers dégradés pour simuler le volume de la planète.
  <img width="760" height="428" alt="Saturne2" src="https://github.com/user-attachments/assets/ff12862b-9392-4441-9942-ea40a557332f" />
* **Étape 3** : Ébauche des premiers anneaux horizontaux.
...
* **Étape 7** : étail des anneaux avec la séparation entre le Grand Anneau (GA) et le Petit Anneau (PA).
  <img width="760" height="428" alt="Saturne7" src="https://github.com/user-attachments/assets/dc3f16a5-5527-4923-8544-95eaef64e97a" />
* **Étape 8** : Utilisation de la planète utilisant le dégradé de couleur.
